...
from padre_craft import __version__
...
html_theme_options = {
   "announcement": "This package is under active development.  If you'd like to contribute, check out our <a href='https://github.com/PADRESat/padre_craft/'>GitHub repository</a>.",
